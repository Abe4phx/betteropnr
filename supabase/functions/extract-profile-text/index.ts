        ...
        messages: [
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Extract all text from this profile screenshot. Return only the text content, organized clearly with line breaks between sections. Do not add any commentary or explanations, just the extracted text.'
              },
              {
                type: 'image_url',
                image_url: {
