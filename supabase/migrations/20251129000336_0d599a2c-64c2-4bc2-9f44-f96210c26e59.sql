-- Drop old RLS policies for users table
...
-- Drop old RLS policies for user_profiles table
...
-- Drop old RLS policies for user_usage table
...
-- Update stripe_customers policy to also use auth.jwt()
