-- Revert RLS policies for users table to use current_setting
...
-- Revert RLS policies for user_profiles table
...
-- Revert RLS policies for user_usage table
...
-- Revert stripe_customers policy
